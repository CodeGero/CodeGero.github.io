...
- Python Dev Tooling
  - [kryptorious-depguard](https://github.com/CodeGero/depguard) - Cross-ecosystem dependency auditor: detects undeclared imports, unused deps, unpinned specifiers, and lockfile drift.
  ...
  - [kryptorious-gitsweep](https://github.com/CodeGero/gitsweep) - Git repository hygiene: prunes stale branches and surfaces forgotten worktrees.
  - [kryptorious-csvclean](https://github.com/CodeGero/csvclean) - Validates and normalizes CSV/TSV files from the command line.
